...
<head>
<meta charset="UTF-8">
<title>Delete Student's Enrollment from specific ClassId</title>
...
<body>
	<h2>Delete Student's Enrollment from specific ClassId</h2>
	<br />
	<p style="color: red;">${errorMessage}</p>
	<br />
	<form method="POST" action="deleteStudentEnrollmentServlet">
		<table>
			<tr>
